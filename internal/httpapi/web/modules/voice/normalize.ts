...
export function containsProjectScopeOverride(input: string): boolean {
...
export function parseSpokenNumber(input: string): ParsedNumber | null {
  ...
  if (!sawNumber || !Number.isSafeInteger(value) || value <= 0) return null;
