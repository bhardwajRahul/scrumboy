...
export type WallTestCatalogs = Record<string, Record<string, string>>;
 ...
 */
export async function initWallTestI18n(catalogs: WallTestCatalogs, locale = "en"): Promise<void> {
  const i18n = await import("../i18n/index.js");
  await i18n.initI18n({
    locale,
    loadLocale: async (loc: string) => catalogs[loc] ?? catalogs.en,
  });
}
//
